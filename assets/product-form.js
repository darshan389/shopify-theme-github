    ...
    class ProductForm extends HTMLElement {
      ...
      onSubmitHandler(evt) {
        ...
        if (this.cart) {
          ...
          // formData.append('sections','cart-notification')
        ...
        fetch(`/cart/add`, config)
          ...
          .finally(() => {
            ...
            document.querySelector(".mini-cart").classList.add('active-cart');
      ...
      toggleSubmitButton(disable = true, text) {
        if (disable) {
          ...
          console.log("DEmo::",window.variantStrings.addToCart)
        }
      }
